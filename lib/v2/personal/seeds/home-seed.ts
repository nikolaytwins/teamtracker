...
export const HOME_SPRINT: HomeSprint = { label: "Цели спринта", dates: "15 — 31 августа · Прелюдия" };
...
export const HOME_SPRINT_GOALS: HomeSprintGoal[] = [
  {
    ...
    tint: "#0E7490",
    bg: "#E6F6FA",
    goal: "Закрыть обязательства",
    items: [
      "Записать все уроки и выложить весь курс",
      "Продавать пассивно только в случае интереса людей, не агрессивно",
    ],
  },
  {
    id: "agency",
    ...
    tint: "#2A56EB",
    bg: "#EFF4FF",
    goal: "Пассивное сопровождение без масштабирования",
    items: ["Обслуживать текущие проекты", "Не брать рост и новые направления"],
  },
  {
    id: "create",
    name: "Творчество и Аркалиум",
    tint: "#7C3AED",
    bg: "#F3EDFF",
    goal: "Выделить 1 день, где я могу творить",
    items: ["Один день в неделю без обязательств", "Без KPI и без обязанности что-то выпустить"],
  },
];
