...
| 056 | `056_v2_personal_sport.sql` | Личный раздел «Спорт»: JSONB doc (недели, программа, тренировки) |
| 057 | `057_v2_personal_observation_conclusions.sql` | Дневник: тип записи «вывод» для месячных выводов |
