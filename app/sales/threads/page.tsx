...
export default function ThreadsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-2">
        <h1 className="text-2xl font-bold text-gray-900">Threads — отклики</h1>
        <p className="text-sm text-gray-500 mt-1">Бесплатные отклики, та же воронка учёта, что и у Profi.</p>
        {visits != null && (
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
        ...
        <form onSubmit={handleQuickAdd} className="flex flex-wrap items-end gap-3">
          <div>
            <label className="block text-xs font-medium text-gray-500 mb-1">Стоимость (₽), обычно 0</label>
            <input
              type="text"
              inputMode="decimal"
              value={quickCost}
