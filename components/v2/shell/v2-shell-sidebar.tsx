          ...
          <nav className="space-y-0.5">
            {personalNav.map((item) => {
              ...
              if (item.href.startsWith("/v2/personal/tasks")) {
                ...
                active = pathname?.startsWith(appPath("/v2/personal/finance")) ?? false;
              } else if (item.href.startsWith("/v2/personal/ideas-tasks")) {
                active =
                  pathname?.startsWith(appPath("/v2/personal/ideas-tasks")) ??
                  pathname?.startsWith(appPath("/v2/personal/tasks")) ??
                  false;
              ...
              } else if (item.href.startsWith("/v2/personal/observations")) {
                active = pathname?.startsWith(appPath("/v2/personal/observations")) ?? false;
                ...
                // Блок Стратегия: общая + бренд + мой код + база данных (манифест — отдельный пункт)
                active =
              ...
              } else if (item.href.startsWith("/v2/personal/manifest")) {
                active = pathname?.startsWith(appPath("/v2/personal/manifest")) ?? false;
              } else if (item.href.startsWith("/v2/personal/calendar")) {
                active = pathname?.startsWith(appPath("/v2/personal/calendar")) ?? false;
              }
