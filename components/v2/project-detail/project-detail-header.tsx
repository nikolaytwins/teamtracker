      ...
      <div className="relative p-7">
        <div className="flex items-start gap-5">
          ...
          <div className="-mt-1 flex items-center gap-1.5">
            ...
            <IconBtn title="Ещё">
              <V2Icons.more className="h-[18px] w-[18px]" />
            </IconBtn>
          </div>
        </div>
            ...
            <div className="relative">
              {runningTask && runningTaskId ? (
                <>
                  ...
                  <div className="mt-1 truncate text-[11.5px] text-white/80">{runningTask.title}</div>
                  <button
                    type="button"
                ...
                <>
                  ...
                  <button
                    type="button"
                    onClick={onToggleTimer}
                    className="v2-tight mt-3 inline-flex h-9 w-full items-center justify-center gap-1.5 rounded-xl bg-white text-[12.5px] font-medium text-[var(--v2-brand-700)] shadow-[var(--v2-shadow-card)] transition hover:bg-[var(--v2-brand-50)]"
                  >
